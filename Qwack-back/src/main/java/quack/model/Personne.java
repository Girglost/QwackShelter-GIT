...
public class Personne {
	...
	public Personne(String nom, String prenom, String login, String password, Lieu habitation,QuackShelter quackShelter) {
		this.nom = nom;
		this.prenom = prenom;
		this.login = login;
	...
	public static Personne createVisiteur(String nom, String prenom, String login, String password, Lieu habitation,QuackShelter quackShelter) {
	...
	public static Personne createBenevole(String nom, String prenom, String login, String password, Lieu habitation,QuackShelter quackShelter) {
	...
	public static Personne createPatron(String nom, String prenom, String login, String password, Lieu habitation,QuackShelter quackShelter) {
	...
	public static Personne createEmploye(String nom, String prenom, String login, String password, Lieu habitation,QuackShelter quackShelter,boolean admin,double salaire) {
